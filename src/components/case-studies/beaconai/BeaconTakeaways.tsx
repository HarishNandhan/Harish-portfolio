...
const takeaways = [
  "Separating concerns into independent pipeline agents makes systems easier to maintain and scale.",
  "Redis as a coordination layer removes tight coupling between data pipeline stages.",
  "Production deployment on GKE means the work survives real operational load, not just demos.",
]

export function BeaconTakeaways() {
  return (
