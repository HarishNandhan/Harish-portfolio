...
const takeaways = [
  "The pipeline is the product. Reliable data delivery matters more than dashboard design.",
  "Every manual step eliminated compounds into faster decisions for the business.",
  "Build for the person using it, not for the data behind it.",
]

export function RamsiTakeaways() {
  return (
