...
const metrics = [
  { icon: Target, label: "Delay Prediction Accuracy", value: "85%+" },
  { icon: Layers, label: "Engineered Features", value: "40+" },
  { icon: GitBranch, label: "Pipeline Stages", value: "6 automated steps" },
  { icon: Zap, label: "Processing", value: "Fully automated end to end" },
]

export function SCMetrics() {
  return (
