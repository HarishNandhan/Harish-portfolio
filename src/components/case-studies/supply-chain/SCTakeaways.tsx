...
const takeaways = [
  "dbt inside BigQuery keeps feature engineering and warehouse modeling in one codebase.",
  "Airflow orchestration turns a fragile manual pipeline into a reliable automated workflow.",
  "Training ML inside BigQuery eliminates data movement and speeds up the prediction cycle.",
]

export function SCTakeaways() {
  return (
